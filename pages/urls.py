...
pages_job_landing,
audit_trail_view,
solicitar_evento_instrucoes,
solicitar_evento_cadastro,
...
urlpatterns = [
        # Profile
    path('pages/profile', view=pages_profile_view, name='pages.profile'),
    path('pages/profile-settings', view=pages_profile_settings_view, name='pages.profile_settings'),
    
    # Audit Trail
    path('pages/audit-trail', view=audit_trail_view, name='audit_trail'),

    # Outras páginas estáticas (se houver)
    ...
    # Blog (exemplo)
    path('pages/blog/grid', view=pages_blog_grid, name='pages.blog.grid'),
    ...
    # Pages
    path("pages/blog-grid",view =pages_blog_grid,name="pages.blog_grid"),
    path("pages/blog-list",view =pages_blog_list,name="pages.blog_list"),
    path("pages/blog-overview",view =pages_blog_overview,name="pages.blog_overview"),
    ...
    path('solicitar-evento/instrucoes', view=solicitar_evento_instrucoes, name='solicitar_evento_instrucoes'),
    path('solicitar-evento/cadastro', view=solicitar_evento_cadastro, name='solicitar_evento_cadastro'),
    path('ajax/check-email-availability/', view=check_email_availability, name='check_email_availability'),

    # Instruções do Sistema
    path('instrucoes-sistema/', view=instrucoes_sistema, name='instrucoes_sistema'),
]
